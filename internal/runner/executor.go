...
// Stop terminates the running server process by sending SIGTERM, escalating
// to SIGKILL if necessary, and reaping the process. It is safe to call Stop
...
func (e *Executor) Stop() error {
    ...
    slog.Info("stopping server", "pid", cmd.Process.Pid)
